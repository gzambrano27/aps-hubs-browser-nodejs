...
class AuthenticationClient {
    constructor(optionalArgs) {
        ...
        this.tokenApi = new api_1.TokenApi(optionalArgs.sdkManager);
        this.usersApi = new api_1.UsersApi(optionalArgs.sdkManager);
    }
    //#region  UsersApi
    /**
    ...
    getTwoLeggedToken(clientId, clientSecret, scopes, optionalArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.tokenApi.fetchToken(`Basic ${clientIDSecret}`, model_1.GrantType.ClientCredentials, undefined, undefined, undefined, undefined, scopes, undefined, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.options);
            return new model_1.TwoLeggedToken(response.content);
        });
    }
    /**
    ...
    getThreeLeggedToken(clientId, code, redirect_uri, optionalArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            if (optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.clientSecret) {
                ...
                const response = yield this.tokenApi.fetchToken(`Basic ${clientIDSecret}`, model_1.GrantType.AuthorizationCode, code, redirect_uri, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.code_verifier, undefined, undefined, undefined, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.options);
                return new model_1.ThreeLeggedToken(response.content);
            }
            else {
                const response = yield this.tokenApi.fetchToken(undefined, model_1.GrantType.AuthorizationCode, code, redirect_uri, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.code_verifier, undefined, undefined, clientId, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.options);
                return new model_1.ThreeLeggedToken(response.content);
            }
        });
    }
    ...
    */
    refreshToken(refreshToken, clientId, optionalArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            if (optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.clientSecret) {
                const clientIDSecret = Buffer.from(`${clientId}:${optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.clientSecret}`).toString(`base64`);
                const response = yield this.tokenApi.fetchToken(`Basic ${clientIDSecret}`, model_1.GrantType.RefreshToken, undefined, undefined, undefined, refreshToken, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.scopes, undefined, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.options);
                return new model_1.ThreeLeggedToken(response.content);
            }
            else {
                const response = yield this.tokenApi.fetchToken(undefined, model_1.GrantType.RefreshToken, undefined, undefined, undefined, refreshToken, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.scopes, clientId, optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.options);
                return new model_1.ThreeLeggedToken(response.content);
            }
        });
    }
    ...
    */
    revoke(token, clientId, tokenTypeHint, optionalArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            if (optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.clientSecret) { // request is for private client 
                const clientIDSecret = Buffer.from(`${clientId}:${optionalArgs === null || optionalArgs === void 0 ? void 0 : optionalArgs.clientSecret}`).toString(`base64`);
